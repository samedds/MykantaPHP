...
<script type="text/javascript" src="/include/croppic/croppic.min.js"></script>
...
<script src="/js/smart-chat-ui/smart.chat.ui.min.js"></script>
		<script src="/js/smart-chat-ui/smart.chat.manager.min.js"></script>
		 <script type="text/javascript" src="/include/chat/chat_bus.js" ></script>
									...
									<div  class="col-sm-6 col-md-6 col-lg-6" style="align:right;">
											 ...
											 <ul id="sparks" class="">
													<li class="sparks-info padding-5">
														<h5> Followers <span class="txt-color-black"><i class="fa fa-rss" data-rel="bootstrap-tooltip" title="Increased"></i> <?php get_subscribers_no($shop_id);?></span></h5>
...
<div class="modal-dialog">
	<div id="verify_body" class="padding-10 modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Verify your Business Account</h4>
		</div>
		<div class="modal-body">
		<br>
			<div class="row">
				<div class="col-sm-12 padding-10">
			 <p class="text-info"> To ensure that customers make purchases from genuine and registered businesses safely, Mykanta verifies and access all business Account created. This may involve visiting business premises and other verification requirements.</p>  
			<p class="text-success padding-10"> After Verification, your Business Page and products will be availble to customers. </p> 
			 <div class="row padding-10"> 
				<div class="col-md-6 padding-10">
				  <h4>Other Benefits</h4> 
				   ...
				   <li>Verification symbol/ stamp. </li>
				   </ul>
		        </div>
				<div class="col-md-6"> <img src="/img/gcheck.png" style="width:150px;" />
			  </div>
		    </div>
		  <h3>Packages</h3> 
		   <center id="agentbox" class="row padding-10">  
		  
		   <label for="pakage3 padding-10" style="width:30%;"> <img src="/img/products_images/mini/1601546150-1261-1y.jpg"  style="width:auto; height:auto; position:relative;" alt=" 1 year verification" title=" 1 year verification">
				  <h4 style="font-size:1.5em;">1 Year  </h4> 
				      <span style="font-size:1.5em;">500.00 Cedis </span></b>
					<p>  <a href="https://mykanta.com/products/mykanta-verification/478/1-year-verification"> Verify for 1 year</a></p>
				</label> 
				 
				 <label for="pakage3 padding-10"  style="width:30%;">
				    <img src="/img/products_images/mini/1601546869-1261-2y.jpg"  style="width:auto; height:auto; position:relative;" alt=" 1 year verification" title=" 1 year verification">
		   
				  <h4 style="font-size:1.5em;">2 Year  </h4> 
				   
				   <span style="font-size:1.5em;">850.00 Cedis </span></b>
				  <p> <a href="https://mykanta.com/products/mykanta-verification/479/2-years-verification"> Verify for 2 year</a></p>
				      </label> 
				
				 
				  <label for="pakage3 padding-10"  style="width:30%;"> 
				    <img src="/img/products_images/mini/1601547006-1261-3y.jpg"  style="width:auto; height:auto; position:relative;" alt=" 1 year verification" title=" 1 year verification"><br>
		 
				  <h4 style="font-size:1.5em;">3 Year  </h4> 
				   
				   <span style="font-size:1.5em;">1,125.00 Cedis </span></b>
				<p>  <a href="https://mykanta.com/products/mykanta-verification/480/3-years-verification"> Verify for 3 years</a></p>
				      </label> 
				
				 
			 <center class="row padding-10"> 
				  <p></p> 
				    <input type="input" id="verify_input" style="width:200px; border-radius:15px;" class="hidden input form-control" required/>  
			 ...
			 <center class="row padding-10"> 
				  <p>Use Agent code as Reference no when transacting.</p> 
				    <input type="input" id="verify_input" style="width:200px; border-radius:15px;" class="hidden input form-control" required/>  
			
		    </center>
			<center class="hidden row padding-10"> 
				  <p>Business Phone Number</p> 
				    <input type="input" id="phone_number" style="width:200px; border-radius:15px;" class="hidden input form-control" required/>  
				...
				<center class="padding-10 row hidden">	<button type="button" id="verify_button" onclick="verify_function(<?php echo $shop_id; ?>)" class="hidden btn btn-sm btn-success" style="height:60px;"> <span style="font-size:1.5em;"> Verify Account </span> </button>
...
<div class="modal fade" id="pending_verify_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
	<div id="verify_body" class="padding-10 modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
			...
			<h4 class="modal-title" id="myModalLabel">Pending Verification - Business Account</h4>
		</div>
		<div class="modal-body">
		<br>
			<div class="row">
