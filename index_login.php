...
<div  class="col-xs-12 col-sm-6 col-md-4 col-lg-4 ">
	...
	<p class="headline  hidden-md hidden-lg" style="color:white; font-size:1.8em;">Login </p>
		<div  class="form col-md-12  no-padding"  autocomplete="off" >
		<div class="form-group no-padding">
		<input type="text" class="form-control input-md"style="border-radius:15px;" placeholder="Username / Email" id="email" autocomplete="off" required />
		</div>
		<div class="form-group no-padding">
		<input type="password" class="form-control input-md" placeholder="Password" autocomplete="off"  id="pass"required />
		...
		<div class="form-group no-padding">
		<button onClick="login_user()"  class="btn-primary-lg-o btn-block">Sign In</button>
...
<label class="input"> <i class="icon-append fa fa-envelope"></i>
	<input type="email" id="email_verify" placeholder="Email address"   />
