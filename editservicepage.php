...
$prdt_nameformat = safe_input($_GET['prdt_nameformat']);
...
<div id="main" role="main">
   <div id="container"  style="margin-top:-10px; ">
   	    <h1 style="margin:0; border:none;" class="pull-left padding-5 text-primary"><a href="/User/my-business/<?php echo $shopName;?>"><?php echo $shopName; ?></a><small> - Edit Service Information</small></h1><div class="row no-padding"style="margin-left:-15px;">
       	<div class="col-md-10 col-lg-10 " >
      <div class="no-margin no-padding">
           
					<div class="row" style="padding-bottom:20px;">
					<?php edit_service($product_id); ?>
...
<input type="hidden" id="hiddenChatMinCheck" value="" />  
	...
	<script type="text/javascript">
		...
		function editpageload1(product_id)
		{
		  ...
		  window.location.href = "/edit_product/"+thisShopName+"/"+product_id+"/"+product_nameformat;
		}
