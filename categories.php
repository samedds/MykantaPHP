...
<div class="" >
<h1 style="font-size:1.8em; color:black;  margin-left:50px; "class=""> Categories</h1>
<ul style="margin-right:10px;">
<div class="row  margin-10" style="">
						<div class="col-md-6 " style="padding-bottom:10px;">
						
					
						<ul class="list-inline padding-10" style="">
							 <li class="padding-10" style="width:45%;">
								<span><a href="/product-category/sca" class="ubuntu_font" title="Software, Computers & Accessories"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-laptop fa-lg"></i>
								Computers</p></a>
								<br><a href="/product-category/sa" class="ubuntu_font" title="Sports & Accessories">	<p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-trophy fa-lg"></i>
							Sports & Accessories</p></a>
								
								</span>
							 </li> 
							
							 <li class="padding-10" style="width:45%;">
								<span><a href="/product-category/acg" class="ubuntu_font" title="Arts & Crafts"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-paint-brush fa-lg"></i>
								Arts & Crafts</p></a>	
								<br>
								<a href="/product-category/at" class="ubuntu_font" title="Auto & Transportation"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-car fa-lg"></i>
								Auto & Transportation</p></a>
								</span>
							 </li> 
							 <li class="padding-10" style="width:45%;">
								<span><a href="/product-category/gt" class="ubuntu_font" title="Gifts & Toys">	<p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-gift fa-lg"></i>
							Gifts & Toys</p></a>
								
								<br>
								<a href="/product-category/eect" class="ubuntu_font" title="Electrical Equipment, Components, & Telecom"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-flash fa-lg"></i>
								Electrical Equipment</p></a></span>
							 </li>
							
							 <li class="padding-10" style="width:45%;">
								<span>	
								<a href="/product-category/afb" class="ubuntu_font" title="Agriculture, Food & Beverage"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-cutlery fa-lg"></i>
								Food & Beverage</p></a>
								<br>
								<a href="/product-category/eea" class="ubuntu_font" title="Electronics & Electrical Appliances"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-television fa-lg"></i>
								Electrical Appliances</p></a>
							</span>
							 </li> 
							 <li class="padding-10" style="width:45%;">
								<span>
								<a href="/product-category/ctjbs" class="ubuntu_font" title="Clothing & Jewelry"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-shopping-bag fa-lg"></i>
								Clothing & Jewelry</p></a>
								<br>
								<a href="/product-category/mht" class="ubuntu_font" title="Machinery, Hardware & Tools"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-wrench fa-lg"></i>
								Machinery & Tools</p></a></span>
							 </li> 
							 <li class="padding-10" style="width:45%;">
								<span><a href="/product-category/sff" class="ubuntu_font" title="Stationery, Furniture & Fittings">	<p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-book fa-lg"></i>
							Stationery & Furniture</p></a>
								<br>
							<a href="/product-category/pao" class="ubuntu_font" title="Packaging, Advertising & Office"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-newspaper-o fa-lg"></i>
								Packaging & Advertising</p></a></span>
							 </li>
							 <li class="padding-10 hidden" style="width:45%;">
								<span><a href="/product-category/me" class="ubuntu_font" title="Media & Entertainment"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-music fa-lg"></i>
								Media & Entertainment</p></a>
								<br>
								<a href="/product-category/mcrp" class="ubuntu_font" title="Metallurgy, Chemicals, Rubber & Plastics"><p style="color:black; font-size:1em;"><i style="color:black; font-size:1.8em;" class="fa-default fa fa-tint fa-lg"></i>
								Chemicals & Rubber</p></a></span>
							 </li>
