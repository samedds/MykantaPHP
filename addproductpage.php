          ...
          <div class=" padding-10">
             <div class="row" style="padding-bottom:5px;">
               <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12" style="padding-left:16px;"> 
				...
				<h1 style="margin:0; border:none;" class="pull-left padding-5 "><?php echo '<a href="/business-link/'.$clean_name2.'">'.$shopName.'  </a>'; ?><small> -  	<a class="  " style="cursor:pointer; color:grey; " data-target="#productterms" data-toggle="modal" class="text-info">Product Listing Policy</a> </small></h1>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="row">
								<div class="col-md-6">
									...
									<input type="text" class="form-control" id="prdt_name"  name="prdt_name" placeholder="Product" required />
									<label class="padding-top-10 text-muted font-sm" style="">Eg: Samsung galaxy S6 Smart phone.</label>
									<div class="" id="nameAlert" style="margin-bottom:2px;"></div>
								</div>
								<div class="col-md-6">
									<label class="" style="font-weight:600;">Product Manufacturer</label>
									<input type="text" class="form-control" id="prdt_man"  name="prdt_man" placeholder="Manufacturer" required />
								...
								<div class="col-md-6">
										<label class="" style="font-weight:600;">Product option</label>
										<input type="text" class="form-control" id="prdt_option" name="prdt_option" placeholder="Type" required />
										<label class="padding-top-10 text-muted font-sm" style="">Eg:  32 GB, 64 GB, 128 GB.  Type Full name if product has only one option. </label>
								...
								<div class="col-md-6">
										...
										<input type="number" class="form-control" id="prdt_stock" name="prdt_stock" placeholder="00" required />
								...
								<div class="col-md-6">
										...
										<input type="number" class="form-control" id="min_order" name="min_order" placeholder="00" required />
										<label class="padding-top-10 text-muted font-sm" style="">Least quantity a customer can order.</label>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<textarea class="form-control" id="prdt_desc" name="prdt_desc" placeholder="Describe your product" rows="3" required></textarea>
							...
							<div class="row">
								<div class="col-md-6">
										...
										<input type="text" class="form-control" id="prdt_color" name="prdt_color" placeholder="Color" required />
								...
								<div class="col-md-6">
										...
										<input type="text" class="form-control" id="prdt_cond" name="prdt_cond" placeholder="Condition" required />
								...
								<section id="morePix" style="display:none; margin-top:15px;">
						    		...
						    		<input type="hidden" id="myfile7" name="myfile7" value="" />
										...
										<ul class="list-inline no-padding">
											<li class="padding-5">
												<button name="saveproduct" title="This saves the product and then refreshes the page back here for a new product entry." type="submit" class="btn btn-success " style="" id="add_product_btn"> Save & Add</button>
											</li>
											<li class="padding-5">
												<button name="saveproduct" title="This saves the product and then goes to edit page for additional details such as other versions of the same product." type="submit" class="btn btn-success " style="" id="add_product_btn_ed"> Save & Edit </button>
											</li>
											<li class="padding-5">
												<button name="saveproduct" title="This saves and goes back to your business page." type="submit" class="btn btn-success" style="" id="add_product_btn_ex">Save & Exit</button>
											</li>
											<li class="padding-5">
											<?php echo '<a href="/business_link/'.$clean_name.'" title="Go back to business page" class="btn btn-default padding-5" id="add_product_btn_ex"> <i class="fa fa-mail-reply"></i> </a>'; ?>
...
<input type="hidden" id="page" value="edit_product" />
