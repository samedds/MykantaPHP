 ...
 class Replies {
	...
	public static function getReplys(  )
	{
	 ...
	 public static function insert( $shop_reply , $user_id , $comment_id )
	 {
	     //insert data 
...
NULL , '$reply','$post_id', '$post_user_id', '$post_user_id', '$account_id', '$datetime' 
	...
	*/	
		  ...
		  $sql = "insert into reply values( '' , '$shop_reply',$comment_id, '', $user_id, '$datetime' )";
