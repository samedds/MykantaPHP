  ...
  <div class="">
	...
	<div class="col-sm-12 col-md-7 col-lg-7"id="box_check_1">
			<div class="row padding-10"> <ul class="bootstrapWizard form-wizard">
											...
											<li>
												<a> <span class="step">3</span> <span class="title">Delivery Option</span> </a>
											</li>
											<li>
		...
		<thead>
			<tr>
				...
				<tbody>
					<th>Total </th>
					<th class="hidden-xs hidden-sm"> </th><th> </th><th > </th><th id="total_result">GHS <?php echo total_cost_items(); ?></th></th><th > 
					<input type="hidden" id="total_result_hidden" value="<?php echo total_cost_items(); ?>" />
				</tbody>
				</table>	
		</div>
		<!-- billing info -->
		<div class=" col-sm-12 col-md-7 col-lg-7 "style="display:none;" id="box_check_2" >
			 <div class="row padding-10"> <ul class="bootstrapWizard form-wizard">
											<li>
												<a> <span class="step">1</span> <span class="title">Your Cart</span> </a>
											</li>
											<li class="active" data-target="#step1">
												<a href="#tab1" data-toggle="tab"> <span class="step">2</span> <span class="title">Billing information</span> </a>
											</li>
											<li>
												<a> <span class="step">3</span> <span class="title">Delivery Option</span> </a>
											</li>
		     ...
		     <hr>
			  <form class="">
    <fieldset class="  client-form no-padding margin-10">
        <div >
            <label for="firstname" class="control-label col-sm-3">First Name *</label>
            <div class="col-sm-3">
                <input id="firstname" name="firstname" type="text" autocomplete="first-name" placeholder="first name" class="form-control">
        ...
        <div class="control-group">
            ...
            <div class="col-sm-3">
                <input id="lastname" name="lastname" type="text" autocomplete="last-name" placeholder="last name" class="form-control">
                <p class="help-block"></p>
            </div>
        </div>
        <!-- telephone input-->
        <div class="control-group">
            <label for="telephone" class="control-label col-sm-3">Telephone *</label>
            <div class="col-sm-3">
                <input id="telephone_bill" name="telephone_bill" type="telephone" autocomplete="telephone" placeholder="Telephone" class="form-control">
                <p class="help-block"></p>
            </div>
        </div> 
		 <!-- postal-code input-->
        <div class="control-group">
            ...
            <div class="col-sm-3">
                <input id="postalcode" name="postal-code" type="text" autocomplete="postal-code" placeholder="zip or postal code" class="form-control">
                <p class="help-block"></p>
            </div>
        </div>
		<!-- address-line1 input-->
        <div class="control-group">
            ...
            <div class="col-sm-9">
                <input id="bill_email" name="bill_email" type="text" autocomplete="bill_email" placeholder="Email" class="form-control">
                <p class="help-block"></p>
            </div>
        </div>
        <!-- address-line1 input-->
        <div class="control-group">
            ...
            <div class="col-sm-9">
                <input id="address-line1" name="address-line1" type="text" autocomplete="address-line1" placeholder="street address, P.O. Box, c/o" class="form-control">
				 <p class="help-block"></p>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="col-sm-9">
                <input id="address-line2" name="address-line2" type="text" autocomplete="address-line2" placeholder="Landmarks, suite , unit, building, floor, etc." class="form-control">
                <p class="help-block"></p>
            </div>
        </div>
        <!-- city input-->
        <div class="control-group">
            ...
            <div class="col-sm-3">
                <input id="city_bill" name="city" type="text" autocomplete="address-level2" placeholder="city" class="form-control">
                <p class="help-block"></p>
            </div>
        </div>
        <!-- region input-->
        <div class="control-group">
            <label class="control-label col-sm-3">Region / State</label>
            <div class="col-sm-3">
                <input id="region_bill" name="region" type="text" autocomplete="address-level1" placeholder="region / state" class="form-control">
                <p class="help-block"></p>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="col-sm-9">
                <select id="country_bill" name="country" autocomplete="country" class="form-control">
		...
		<center class="text-danger" id="bill_info_box"></center>
		 ...
		 <!-- delivery -->
		 <div class=" col-sm-12 col-md-7 col-lg-7 "style="display:none;" id="box_check_3" >
			 <div class="row padding-10"> <ul class="bootstrapWizard form-wizard">
											<li>
												<a> <span class="step">1</span> <span class="title">Your Cart</span> </a>
											</li>
											...
											<li class="active" data-target="#step1">
												<a href="#tab1" data-toggle="tab"> <span class="step">3</span> <span class="title">Delivery Option</span> </a>
											</li>
											<li>
												<a > <span class="step">4</span> <span class="title">Order </span> </a>
											</li>
	...
	<?php 
	  ...
	  if($query4user_info = mysqli_query($link,$query))
		...
		<button id="check_out_btn" onclick="check_out_next()" class="btn btn-success pull-right" value="">Check Out</button>
