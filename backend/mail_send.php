...
$query = "SELECT email FROM registration WHERE id = '$user_id' ";
$queryinfo = mysqli_query($link,$query);
if($query_rows  = mysqli_num_rows($queryinfo))
	{
	while($query_fetch = mysqli_fetch_array($queryinfo,MYSQLI_ASSOC))
		{
		 $email = $query_fetch['email'];		
		$mail_co = 'support@mykanta.com';
		$headers = 'MIME-Version: 1.0'. "\r\n";
		$headers .= 'Content-type:text/html;charset=UTF-8'. "\r\n";
		$headers .= 'From: mykanta Feedback'. "\r\n";
...
'.$username.' has sent a user feedback with email : '.$email.'
'.$message.'
...
//used at the contact page 
else if(isset($_POST['mail_send_to_all']))
{
include "include/conxn.php";
...
$subject = $_POST['subject'];
$user_id = $_SESSION['id'];
$query = "SELECT email FROM shop";
$queryinfo = mysqli_query($link,$query);
if($query_rows  = mysqli_num_rows($queryinfo))
	{
	while($query_fetch = mysqli_fetch_array($queryinfo,MYSQLI_ASSOC))
		{
		 $email = safe_input($query_fetch['email']);		
		//send to mail
		$mail_co = 'support@mykanta.com';
		$headers = 'MIME-Version: 1.0'. "\r\n";
		$headers .= 'Content-type:text/html;charset=UTF-8'. "\r\n";
...
<p><img src="http://www.mykanta.com/img/site_img/email_pics/email_bus_update.png" /></p>	
'.$message.'
<table style="color:black; font-size:9pt;">
<tr>
	<td align="center">
...
else if(isset($_POST['mail_send_to_all_user']))
{
include "include/conxn.php";
include "include/sessionfile.php";
include "include/funcxn.php";
...
$subject = $_POST['subject'];
$user_id = $_SESSION['id'];
$query = "SELECT email FROM test_users";
$queryinfo = mysqli_query($link,$query);
if($query_rows  = mysqli_num_rows($queryinfo))
	{
	while($query_fetch = mysqli_fetch_array($queryinfo,MYSQLI_ASSOC))
...
<body class="" style="width:500px; border:5px solid #443b3e">	
	<img src="http://www.mykanta.com/img/site_img/email_pics/thank_you.jpg" style="width:100%;" />
...
//mail($emailu,$subject,$message_user,$headers);
mail($mail_co,$subject,$message_user,$headers);

}
else if(isset($_POST['task_feedback']))
{
include "include/conxn.php";
include "../include/funcxn.php";
include "../include/sessionfile.php";
...
echo $message_user =  '<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta name="viewport" content="width=device-width" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<title>Connection Request</title>
...
<h3>Product Order</h3>
<p><img src="http://www.mykanta.com/img/site_img/email_mk.png" /></p>	
<p class="text-info"> Email : '.$email.'</p>
<p class="text-info"> Subject : '.$subject.'</p>
<br>
<p> message : '.$message.'</p>
<table style="color:black; font-size:9pt;">
<tr>
...
mail($mail_from,$subject,$message_user,$headers);
mail($email,$subject,$message_user,$headers);

}
else if(isset($_POST['task_invite']))
{
include "include/conxn.php";
include "../include/funcxn.php";
include "../include/sessionfile.php";
 ...
 $email = $_POST['email'];
 $subject = "Mykanta Business Invitation";
 $message = $_POST['message'];
...
$headers .= 'From: mykanta.com<no-reply@mykanta.com>'. "\r\n";
$mail_from = 'support@mykanta.com';
 $message_bus =  '<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta name="viewport" content="width=device-width" />
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
...
<body class="padding-10">	
<p><img src="http://www.mykanta.com/img/site_img/email_mk.png" /></p>	
<p class="text-info"> A Business has been  invited to create a page</p>
<br>
<p> message : '.$message.'</p>
<table style="color:black; font-size:9pt;">
<tr>
...
<body class="padding-10">	
<p><img src="http://www.mykanta.com/img/site_img/email_mk.png" /></p>	
<p class="text-info"> Your Business has been invited by a user to a create a Business page</p>
<em> click here to create an account <a href="http://www.mykanta.com/create_account_mobile">Create account</a>
<br>
<table style="color:black; font-size:9pt;">
<tr>
	<td align="center">
...
mail($mail_from,$subject,$message_bus,$headers);
mail($email,$subject,$message_user,$headers);
