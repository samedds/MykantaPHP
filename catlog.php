...
<h2 class ="text-primary"><?php echo $category;?></h2>
<ul class="list-inline">
<?php include "include/product_category.php";?>
</ul>		
</div>
<div class="col-sm-12 col-md-12 col-lg-6">
</div>
<div class="col-sm-12 col-md-12 col-lg-6" style="margin-top:10px;">
</div>
</div>
</div>
</div>
<!-- END MAIN CONTENT --><?php footer(); ?>	
</div>
