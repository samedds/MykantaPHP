...
console.log(f=d.attr("alt")+' - '+posid+' - '+posid1);
...
document.getElementById('posid_box').innerHTML ='<input type="hidden" id="posid" value="'+f+'"/>'; 
console.log(f+' - '+posid+' - '+posid1);
f=d.attr("alt");
