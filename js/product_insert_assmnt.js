$(document).ready( function () { $('#add_product_btn').click(function () { add_product_btn_click(); });
    $('#saveoptionbtn').click(function() { saveoptionbtn_click();
 } );

 $('#update_product_btn').click(function () {
 update_product_btn_click();
 } );
...
function editpageload(product_id)
{
  ...
  window.location.href = "/001assmnt/edit_assd_prdt_page.php?shopName=" + thisShopName + "&product_id=" + product_id + "&prdt_nameformat=" + product_nameformat;
} 
								...
								if( prdt_color.length > 0)
								{
									...
									if( prdt_cond.length > 0)
									{
										...
										if(myfile1.length > 0)
										{
											...
											//post to php
											$.post("/001assmnt/assd_add_product_prc.php",  
											{
												task : "task",
											  	shop_id : shop_id,
											  	shopName : shopName,
