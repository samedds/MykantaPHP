...
<div id="" style="">
 	...
 	<div id="content">
		<div class="row wall paper no-padding ubuntu_all" >
		<ul class="nav nav-tabs  col-md-6" style="background-color:gray;">
<li class="active" style="">
<a href="#a1"  data-toggle="tab">	<h4 class="text-primary ubuntu_all">Product Oriented Business
</h4></a>
</li>
<li>
<a href="#a2" data-toggle="tab"><h4 class="text-primary ubuntu_all">Service Oriented Business</h4></a>
</li> 
</ul>
		...
		<div class="tab-pane fade in active" id="a1">								
			<div class="col-sm-6 padding-10" style=" margin-left:1px;">
               ...
               <form>
				...
				<p class="padding-10" style="color:black; font-size:1.9em;">Create your Business page for products</p>
		...
		<div class="tab-pane fade in " id="a2">								
			<div class="col-sm-6 padding-10" style=" margin-left:1px;">
				<div class="comment-holder-ul list-inline padding-10" > 	
						...
						<div class="row">
						<p class="padding-10" style="color:black; font-size:1.9em;">Create your Business page for services</p>
								  <section class="col col-6">
								  <span style="color:black; font-size:1.2em;">Business Name</span>
								<label class="input"><i class="icon-append fa fa-home"></i>
						...
						<b class="tooltip tooltip-top-right"><span class="text-danger">Warning</span><br>Without country Code Eg: 277100100 </b> 
					      ...
					      <div class="row padding-10">
							...
							<span style="color:black; font-size:1.2em;"> Main Services Performed</span>
								<label class="input"> <i class="icon-append fa fa-shopping-cart"></i>
									<input type="text" id="serv_core_products" placeholder="Core services eg: plumbing, capenter, Contractor etc."/>
