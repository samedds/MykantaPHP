...
<div class="row  " style=" margin-top:-10px;">
			<ul class="row padding-10" style="">
				<?php 
				//include "conxn.php";
$main_user_id  = $_SESSION['id'];
$query = "SELECT shop_id FROM subscribers WHERE user_id = '$main_user_id'";	 
...
echo ' 
<li class="padding-10" title="Shop" align=""  >
<a style="" href="/subsbribed-business/'.$shopNameformat1.'"><img src="/'. $banner_image.'" alt="change" class="img img-thumbnail" style= "height:120px; width:100%;"  title="'.$shopNames.'" /></a>
<strong ><a style="padding-left:10px;" href="/subsbribed-business/'.$shopNameformat1.'">'.$shopNames.'</a></strong>
</li>
';}
}else{ 
echo ' 
<li class=" " title="Shop" align="">
		<a style="" href="/subsbribed-business/'.$shopNameformat1.'"><img src="/img/banners/banner-small.png"  title="'.$shopNames.'" class="img img-thumbnail" style="height:120px; width:100%;"/></a>
			
				 <strong><a style="padding-top:10px;" href="/subsbribed-business/'.$shopNameformat1.'">'.$shopNames.'</a></strong>
		</li>
<br>
<br>
';
